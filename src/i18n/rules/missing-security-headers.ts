...
export const bundle: RuleBundle = {
  en: {
    ...
    beforeApplying: 'A strict Content-Security-Policy is the one header that can break a working site, usually by blocking an analytics or embed script. Start in report-only mode, read what it would have blocked, then enforce.',
    notes: {
  ...
  vi: {
    ...
    beforeApplying: 'Content-Security-Policy chặt là header duy nhất có thể làm hỏng một site đang chạy tốt, thường vì chặn script analytics hay embed. Hãy bắt đầu ở chế độ report-only, xem nó định chặn gì, rồi mới bật enforce.',
    notes: {
