...
export const bundle: RuleBundle = {
  en: {
    ...
    why: 'In {file} (line {line}) we found {kind}: development behaviour that stays switched on in a deployed app. Error details name your files, your libraries and often your database — a stranger reading them learns exactly what to try next.',
  ...
  vi: {
    ...
    why: 'Trong {file} (dòng {line}) chúng tôi thấy {kind}: hành vi dành cho development nhưng vẫn bật khi app đã deploy. Chi tiết lỗi nêu ra tên file, thư viện và thường cả database của bạn — người lạ đọc được là biết ngay nên thử gì tiếp.',
