...
export const bundle: RuleBundle = {
  en: {
    ...
    why: 'Your sign-in path ({file}) can be called as fast as a script can call it, as far as your code is concerned. That allows password guessing at machine speed, and — where each attempt sends an email or an SMS — it turns your login form into someone else spam service, billed to you. If you set a limit at your host or in your auth provider, you are covered; we cannot see those from files.',
