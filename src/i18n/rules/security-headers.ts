...
export const bundle: RuleBundle = {
  en: {
    ...
    why: 'We asked {url} for its home page and read the response: {missing} are not there. This is what your visitors browsers actually receive, whatever your config says. Without these, a browser will embed your site inside someone elses page, guess file types, or run scripts that were injected into your content.',
